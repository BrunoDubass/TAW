...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [self.routesTable[indexPath.row] name];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%f kilómetros", [self.routesTable[indexPath.row]distance]];
